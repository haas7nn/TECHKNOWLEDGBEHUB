...
/**
 * creator dashboard
 * overview of how my tutorials and stats are looking
...
// just showing the basic layout for now
$page_title = 'Creator Dashboard';

// getting user stats will fix this up once the tutorial class is finished
$user = new User();
$user_stats = $user->getUserStats($current_user_id);

// using mock data for now replace with real db queries when tutorial class is ready
$total_tutorials = $user_stats['total_tutorials'] ?? 0;
$total_views = 0; // will calculate this from tutorials later
$total_ratings = $user_stats['total_ratings'] ?? 0;
$avg_rating = 0; // will calculate this from tutorials later
